...
### Dense Mode (5-col, 6pt) — when content is heavy
...
### Spacious Mode (4-col, 6.5pt) — when readability matters
...
cp en/dense.tex en/my-exam.tex
vim en/my-exam.tex

# Build
cd en && latexmk -xelatex my-exam.tex
```
